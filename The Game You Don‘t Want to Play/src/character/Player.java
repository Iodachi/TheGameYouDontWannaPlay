		...
		try {
			...
			if (sc.hasNext("i")) {
				...
				while (sc.hasNextInt()) {
					...
					if (a == 30)
						this.inventory.push(new Key(-1, -1, "gold"));
					else if (a == 31)
						this.inventory.push(new Key(-1, -1, "cyan"));
					else if (a == 32)
						this.inventory.push(new Key(-1, -1, "bronze"));
					else if (a == 33)
						this.inventory.push(new Key(-1, -1, "purple"));
					else if (a == 34)
						this.inventory.push(new Key(-1, -1, "silver"));
					else if (a == 40)
						this.inventory.push(new BloodVial(-1, -1, "big"));
					else if (a == 41)
						this.inventory.push(new BloodVial(-1, -1, "small"));
					else if (a == 43)
						this.inventory.push(new Bomb(-1, -1));
				}
			}
			sc.next(); // consume )
			...
			while (sc.hasNextInt()) {
				...
				if (gear != -1)
					...
					this.armor = new Armor(-1, -1, 0);
				else if (gear == 71)
					this.armor = new Armor(-1, -1, 1);
				else if (gear == 72)
					this.armor = new Armor(-1, -1, 2);
				else if (gear == 73)
					this.weapon = new Weapon(-1, -1, 0);
				else if (gear == 74)
					this.weapon = new Weapon(-1, -1, 1);
				else if (gear == 75)
					this.weapon = new Weapon(-1, -1, 2);
				else if (gear == 76)
					this.wing = new Wing(-1, -1, 0);
				else if (gear == 77)
					this.wing = new Wing(-1, -1, 1);
				else if (gear == 78)
					this.wing = new Wing(-1, -1, 2);
			}
